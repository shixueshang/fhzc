package com.fhzc.app.dao.mybatis.thirdparty.sms;
...
/**
 * Created by lihongde on 2016/8/9 18:52
 */
public class SMSTemplate {
    ...
    private String apikey;  //apikey秘钥（请登录 http://m.5c.com.cn 短信平台-->账号管理-->我的信息 中复制apikey）

    private  String content;  //要发送的短信内容，特别注意：签名必须设置，网页验证码应用需要加添加【图形识别码】。


    public SMSTemplate(String username, String password, String apikey, String content){
    ...
    public void sendTemplateSMS(String mobile){
        //连接超时及读取超时设置
