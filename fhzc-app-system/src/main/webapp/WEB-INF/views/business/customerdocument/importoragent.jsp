                                    ...
                                    <div class="tab-pane active" id="portlet_tab1">
                                        ...
                                        <form action="importagent" enctype="multipart/form-data" method="POST" class="form-horizontal">
                                            ...
                                            <div class="form-actions">
						                        ...
						                        <button type="submit" class="btn blue"><i class="icon-ok" id="approvalScoreAgent"></i> 执行计算待审批积分</button>
                                            </div>
                                        </form>
                                        <!-- END FORM-->
                                    </div>
...
<script>
	...
	$("#approvalScoreAgent").click(function(){
		$.ajax({
			type: "GET",
			contentType: "application/json; charset=utf-8",
			url: "/business/customerdocument/approvalScoreAgent",
			dataType: "json",
