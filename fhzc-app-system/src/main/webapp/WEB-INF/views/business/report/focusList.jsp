...
<div class="page-container row-fluid">
    ...
    <div class="page-content">
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <form name="searchForm" class="form-inline" action="/business/report/focusFind">
                    <div class="form-group">
                   		<label class="control-label" style="margin-left: 20px">投研报告名称:</label>
                        <input class="form-control" name="reportName" placeholder="输入投研报告名称"  >
