        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active"><a href="javascript:void(0);">权益分类</a></li>
                    </ul>
                            ...
                            <div class="tabbable portlet-tabs">
                                <div class="tab-content">
                                    <div class="tab-pane active" id="portlet_tab1">
                                        <!-- BEGIN FORM-->
                                        <form action="<%=contextPath%>/business/rights/type/add" id="form_sample_1" method="POST" class="form-horizontal">
                                            ...
                                            <div class="control-group">
                                                <label class="control-label">权益类型值</label>
                                                <div class="controls">
                                            ...
                                            <div class="control-group">
                                                <label class="control-label">权益类型</label>
                                                <div class="controls">
                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-body">
                            <table class="table table-bordered table-hover">
                                ...
                                <c:forEach items="${rightsTypes}" var="rightsType">
                                    <tr>
                                        <td>${rightsType.value}</td>
                                        <td>${rightsType.key}</td>
                                        <td>
                                            <a href="#modal_edit" role="button" class="btn mini purple mod_ptype" data-toggle="modal" data-id="${rightsType.id}" data-key="${rightsType.key}" data-value="${rightsType.value}"><i class="icon-edit"></i> 修改</a>
                                            <a href="#modal_del" role="button" class="btn mini black del_ptype" data-toggle="modal" data-id="${rightsType.id}" ><i class="icon-trash"></i> 删除</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
            ...
            <div id="modal_edit" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="my_modal_edit" aria-hidden="true">
                ...
                <div class="modal-body">
                    <p><input type="text" id="rightsType_key" value="" class="m-wrap large"></p>
                    <input type="hidden" id="dict_id" />
                    <input type="hidden" id="rightsType_value" />
                </div>
...
<script>
    ...
    $(function(){
        ...
        $(".mod_ptype").click(function(){
            $("#rightsType_key").val($(this).data('key'));
            $("#dict_id").val($(this).data('id'));
            $("#rightsType_value").val($(this).data('value'));
        });
        ...
        $("#do_del_productType").click(function () {
            $.get("<%=contextPath%>/business/rights/type/delete/" + $("#ptype_del_id").val(),function (data) {
                if(!data.success){
        ...
        form1.validate({
            ...
            ignore: "",
            messages: {
                value:{required:"权益类型值不能为空！",remote:jQuery.format("权益类型值已经存在")},
                key:{required:"权益类型不能为空",remote:jQuery.format("权益类型已经存在")}
            },
            rules: {
                value: {
                    required: true,
                    remote: {
                        url: "/business/rights/isValueExists",
                        type: "get",
                        data: {
                            value: function() {
                                var old_value = '${rightsType.value}';
                ...
                key: {
                    required: true,
                    remote: {
                        url: "/business/rights/isKeyExists",
                        type: "get",
                        data: {
                            key: function() {
                                var old_key = '${rightsType.key}';
