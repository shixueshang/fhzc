...
<div class="page-container row-fluid">
    ...
    <div class="page-content">
        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <form name="searchForm" class="form-inline" action="/business/activity/focusFind">
                    <div class="form-group">
                   		<label class="control-label" style="margin-left: 20px">活动名称:</label>
                        <input class="form-control" name="activtyName" placeholder="输入活动名称"  >
