        ...
        <div class="container-fluid">
            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <ul class="breadcrumb">
                        ...
                        <li class="active"><a href="javascript:void(0);">活动分类</a></li>
                    </ul>
                            ...
                            <div class="tabbable portlet-tabs">
                                <div class="tab-content">
                                    <div class="tab-pane active" id="portlet_tab1">
                                        <!-- BEGIN FORM-->
                                        <form action="<%=contextPath%>/business/activity/type/add" id="form_sample_1" method="POST" class="form-horizontal">
                                            ...
                                            <div class="control-group">
                                                <label class="control-label">活动类型值</label>
                                                <div class="controls">
                        ...
                        <div class="portlet-body">
                            <table class="table table-bordered table-hover">
                                ...
                                <c:forEach items="${activityTypes}" var="activityType">
                                    <tr>
                                        <td>${activityType.value}</td>
                                        <td>${activityType.key}</td>
                                        <td>
                                            <a href="#modal_edit" role="button" class="btn mini purple mod_ptype" data-toggle="modal" data-id="${activityType.id}" data-key="${activityType.key}" data-value="${activityType.value}"><i class="icon-edit"></i> 修改</a>
                                            <a href="#modal_del" role="button" class="btn mini black del_ptype" data-toggle="modal" data-id="${activityType.id}" ><i class="icon-trash"></i> 删除</a>
                                        </td>
                                    </tr>
                                </c:forEach>
                                </tbody>
            ...
            <div id="modal_edit" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="my_modal_edit" aria-hidden="true">
                ...
                <div class="modal-body">
                    <p><input type="text" id="activityType_key" value="" class="m-wrap large"></p>
                    <input type="hidden" id="dict_id" />
                    <input type="hidden" id="activityType_value" />
                </div>
...
<script>
    ...
    $(function(){
        ...
        $(".mod_ptype").click(function(){
            $("#activityType_key").val($(this).data('key'));
            $("#dict_id").val($(this).data('id'));
            $("#activityType_value").val($(this).data('value'));
        });
        ...
        $("#do_del_productType").click(function () {
            $.get("<%=contextPath%>/business/activity/type/delete/" + $("#ptype_del_id").val(),function (data) {
                if(!data.success){
        ...
        form1.validate({
            ...
            ignore: "",
            messages: {
                value:{required:"活动类型值不能为空！",remote:jQuery.format("活动类型值已经存在")},
                key:{required:"活动类型不能为空",remote:jQuery.format("活动类型已经存在")}
            },
            rules: {
                value: {
                    required: true,
                    remote: {
                        url: "/business/activity/isValueExists",
                        type: "get",
                        data: {
                            value: function() {
                                var old_value = '${activityType.value}';
                ...
                key: {
                    required: true,
                    remote: {
                        url: "/business/activity/isKeyExists",
                        type: "get",
                        data: {
                            key: function() {
                                var old_key = '${activityType.key}';
