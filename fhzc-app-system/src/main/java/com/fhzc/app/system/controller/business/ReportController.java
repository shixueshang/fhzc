...
public class ReportController extends BaseController {
    ...
    public ModelAndView listType(){
        ModelAndView mav = new ModelAndView("business/report/reportType");
        mav.addObject("reportTypes", dictionaryService.findDicByType(Const.DIC_CAT.REPORT_CATEGORY));
        mav.addObject("url", "business/report");
        return mav;
    }
    ...
    public Object isKeyExists(String key){
        boolean flag = dictionaryService.isKeyOrValueExists(Const.DIC_CAT.REPORT_CATEGORY, "key", key);
        return !flag;
    }
    ...
    public Object isValueExists(String value){
        boolean flag = dictionaryService.isKeyOrValueExists(Const.DIC_CAT.REPORT_CATEGORY, "value", value);
        return !flag;
    }
    ...
    public AjaxJson delete(@PathVariable(value = "id") Integer id){
        ...
        List<Report> reports = reportService.getReportByType(dictionary.getValue());
        if(reports.size() > 0){
