...
INSERT INTO `system_module` (`id`,`name`,`url`,`desc`,`parent_module_id`,`level`,`is_valid`) VALUES (21,'用户列表','/system/admin/list',NULL,16,3,1);
INSERT INTO `system_module` (`id`,`name`,`url`,`desc`,`parent_module_id`,`level`,`is_valid`) VALUES (22,'用户新增','/system/admin/pub',NULL,16,3,1);
