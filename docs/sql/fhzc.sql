...
-- -----------------------------------------------------
-- Table `bank`.`about_app`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bank`.`about_app` ;

CREATE TABLE IF NOT EXISTS `bank`.`about_app` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `version` VARCHAR(45) NULL DEFAULT NULL COMMENT '版本',
  `introduction` TEXT NULL DEFAULT NULL COMMENT '简介',
  `is_using` INT(1) NULL DEFAULT NULL COMMENT '是否正在使用',
  `type` VARCHAR(10) NULL DEFAULT NULL COMMENT '类型1、关于App2、联系我们',
  `android_url` VARCHAR(255) NULL DEFAULT NULL COMMENT '安装包下载地址',
  `ios_url` VARCHAR(255) NULL DEFAULT NULL,
  PRIMARY KEY (`id`))
  ENGINE = InnoDB
  AUTO_INCREMENT = 3
...
CREATE TABLE IF NOT EXISTS `bank`.`activity` (
  ...
  `sponsor` VARCHAR(500) NULL DEFAULT NULL COMMENT '活动主办方',
...
CREATE TABLE IF NOT EXISTS `bank`.`assets_history` (
  ...
  `ctime` DATETIME NOT NULL,
  `dead_date` DATE NULL DEFAULT NULL COMMENT '截至日期',
...
CREATE TABLE IF NOT EXISTS `bank`.`banner` (
  ...
  `status` INT(1) NULL DEFAULT NULL COMMENT 'banner状态(0上线1已下线)',
  PRIMARY KEY (`id`))
  ENGINE = InnoDB
  AUTO_INCREMENT = 9
  DEFAULT CHARACTER SET = utf8;
...
CREATE TABLE IF NOT EXISTS `bank`.`planner_achivements_daily` (
  ...
  `period` INT(11) NULL DEFAULT NULL COMMENT '期限',
  `product_type` VARCHAR(45) NULL DEFAULT NULL COMMENT '产品类型',
  `memo` VARCHAR(255) NULL DEFAULT NULL COMMENT '备注',
  `ctime` DATETIME NOT NULL,
  `company` INT(11) NULL DEFAULT NULL COMMENT '理财师所属分公司',
  `team` INT(11) NULL DEFAULT NULL COMMENT '理财师所属团队',
  `department_id` INT(11) NULL DEFAULT NULL COMMENT '理财师所属部门',
  `area` INT(11) NULL DEFAULT NULL COMMENT '区总',
  `root_dept` INT(11) NULL DEFAULT NULL COMMENT '顶级机构',
  PRIMARY KEY (`id`))
  ENGINE = InnoDB
  AUTO_INCREMENT = 11
  DEFAULT CHARACTER SET = utf8
...
CREATE TABLE IF NOT EXISTS `bank`.`planner_customer` (
  ...
  `memo` TEXT NULL DEFAULT NULL COMMENT '理财师给客户的备注',
  PRIMARY KEY (`id`))
  ENGINE = InnoDB
  DEFAULT CHARACTER SET = utf8
  COMMENT = '客户理财师关系表';
...
CREATE TABLE IF NOT EXISTS `bank`.`product` (
  ...
  `is_renew` INT(1) UNSIGNED NULL DEFAULT '0' COMMENT '是否是续存期产品 0否|1是',
  ...
  `invest_term` VARCHAR(45) NULL DEFAULT NULL COMMENT '投资期限',
  PRIMARY KEY (`pid`),
...
CREATE TABLE IF NOT EXISTS `bank`.`push_token` (
  ...
  `bind_date` DATETIME NULL DEFAULT NULL COMMENT '绑定日期',
  `is_delete` INT(1) NULL DEFAULT NULL COMMENT '数据状态',
  PRIMARY KEY (`id`))
  ENGINE = InnoDB
  DEFAULT CHARACTER SET = utf8
  COMMENT = '消息推送';
...
-- -----------------------------------------------------
-- Table `bank`.`rank_month`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bank`.`rank_month` ;

CREATE TABLE IF NOT EXISTS `bank`.`rank_month` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `planner_id` INT(11) NULL DEFAULT NULL COMMENT '理财师id',
  `year_month` DATE NOT NULL COMMENT '年月',
  `annualised` INT(11) NULL DEFAULT NULL COMMENT '年化业绩',
  `department_id` INT(11) NULL DEFAULT NULL COMMENT '部门id',
  `rank` INT(11) NULL DEFAULT NULL COMMENT '全公司排名',
  `department_rank` INT(11) NULL DEFAULT NULL COMMENT '部门排名',
  PRIMARY KEY (`id`),
  UNIQUE INDEX `pl_rank_uniq` (`planner_id` ASC, `year_month` ASC, `department_id` ASC))
  ENGINE = InnoDB
  AUTO_INCREMENT = 49
  DEFAULT CHARACTER SET = utf8
  COMMENT = '月业绩排名';
...
-- -----------------------------------------------------
-- Table `bank`.`rank_year`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bank`.`rank_year` ;

CREATE TABLE IF NOT EXISTS `bank`.`rank_year` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `planner_id` INT(11) NULL DEFAULT NULL COMMENT '理财师id',
  ...
  `department_rank` INT(11) NULL DEFAULT NULL COMMENT '部门排名',
  PRIMARY KEY (`id`),
  UNIQUE INDEX `pl_rank_uniq` (`planner_id` ASC, `year` ASC, `department_id` ASC))
  ENGINE = InnoDB
  AUTO_INCREMENT = 49
  DEFAULT CHARACTER SET = utf8
  COMMENT = '年业绩排名';
...
CREATE TABLE IF NOT EXISTS `bank`.`report` (
  ...
  `url` VARCHAR(2000) NULL DEFAULT NULL COMMENT '投研报告外部url',
  `ctime` DATETIME NOT NULL,
...
CREATE TABLE IF NOT EXISTS `bank`.`rights` (
  ...
  `name` VARCHAR(45) NOT NULL COMMENT '权益名称',
  ...
  `supply` VARCHAR(255) NULL DEFAULT NULL COMMENT '供应商',
...
-- Table `bank`.`suggest`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bank`.`suggest` ;

CREATE TABLE IF NOT EXISTS `bank`.`suggest` (
  `id` INT(10) UNSIGNED NOT NULL AUTO_INCREMENT,
  `type` VARCHAR(45) NULL DEFAULT NULL COMMENT '问题类型',
  `content` TEXT NULL DEFAULT NULL COMMENT '问题内容',
  `imgs` TEXT NULL DEFAULT NULL COMMENT '问题图片',
  `mobile` VARCHAR(45) NULL DEFAULT NULL COMMENT '电话号码',
  PRIMARY KEY (`id`))
  ENGINE = InnoDB
  DEFAULT CHARACTER SET = utf8
  COMMENT = '用户反馈';
...
CREATE TABLE IF NOT EXISTS `bank`.`system_log` (
  ...
  `method` VARCHAR(200) NULL DEFAULT NULL COMMENT '方法',
  `type` VARCHAR(10) NULL DEFAULT NULL COMMENT '操作类型',
  `level` VARCHAR(10) NULL DEFAULT NULL COMMENT '日志级别',
  `request_ip` VARCHAR(45) NULL DEFAULT NULL COMMENT '请求ip',
  `exception_code` VARCHAR(45) NULL DEFAULT NULL COMMENT '异常代码',
  `exception_detail` VARCHAR(200) NULL DEFAULT NULL COMMENT '异常描述',
  `params` VARCHAR(45) NULL DEFAULT NULL COMMENT '参数',
...
-- -----------------------------------------------------
-- Table `bank`.`system_notice`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bank`.`system_notice` ;

CREATE TABLE IF NOT EXISTS `bank`.`system_notice` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `bank`.`system_notice_record`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bank`.`system_notice_record` ;

CREATE TABLE IF NOT EXISTS `bank`.`system_notice_record` (
  `id` INT(11) NOT NULL AUTO_INCREMENT,
  `notice_id` INT(11) NULL DEFAULT NULL COMMENT '消息id',
  `user_id` INT(11) NULL DEFAULT NULL COMMENT '推送用户',
  `content` TEXT NULL DEFAULT NULL COMMENT '内容',
  `push_status` INT(1) NULL DEFAULT NULL COMMENT '推送状态0未推送1、待推送2、已推送',
  `push_channel` INT(1) NULL DEFAULT NULL COMMENT '推送途径1、系统2、短信3、推送4、邮件',
  PRIMARY KEY (`id`))
  ENGINE = InnoDB
  DEFAULT CHARACTER SET = utf8
  COMMENT = '推送记录表';
...
-- -----------------------------------------------------
-- Table `bank`.`verify_code`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `bank`.`verify_code` ;

CREATE TABLE IF NOT EXISTS `bank`.`verify_code` (
  `id` BIGINT(20) NOT NULL AUTO_INCREMENT COMMENT '编号',
  `mobile` VARCHAR(30) NULL DEFAULT '' COMMENT '手机号',
  `code_value` VARCHAR(6) NULL DEFAULT '' COMMENT '验证码内容',
